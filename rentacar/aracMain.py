from aracKirala import BikeRent, CarRent, Customer
...
while True:
    ...
    if choice == "A" or choice == "a":
        ...
        if choice == 1:
            ...
            customer.rentalTime_b = bike.Daily(customer.requestVehicle("bike"))
        ...
        if choice == 1:
            ...
            customer.rentalTime_c = car.Daily(customer.requestVehicle("car"))
        ...
        print("Invalid error. Please enter A-B-Q")
        main_menu = True
